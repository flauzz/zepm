sap.ui.define(
    [
        ...
        "use strict";
        return Controller.extend("epm11.controller.Main", {    
            onInit: function() {
                ...
                oRouter.getRoute("RotaDetalhe").attachPatternMatched(function(oEvent){
                    ...
                    let sCaminho = oModel.createKey("/BusinessPartnerSet", {
            ...
            aoCancelar: function(oEvent){
                ...
                MessageBox.show("Deseja cancelar a edição?", {
                    ...
                    }.bind(this) //salva o contexto do this apontando para o controller fora da função
                });
           },
           ...
           aoSalvar: function(oEvent) {
                ...
                //adiciona o ícone de carregamento
                oForm.setBusy(true);
                ...
                if(oDados.PartnerId) {
                    ...
                    oModel.create("/BusinessPartnerSet", oDados, {
                        success: function(oData) {
            ...
            inicializarModelosLocais: function() {
                ...
                //criar propriedade visualizar que controla o modo de visualização
                oModeloBotao.setProperty("/visualizar", true);
                //criar propriedade editar que controla o modo de edição
